...
class CadastroModule extends CWebModule
{
	...
	public function getAssetsUrl() {
		if ($this->_assetsUrl === null)
			$this->_assetsUrl = Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('cadastro.assets'));
	...
	public function registerCss($file, $media = 'all') {
		...
		Yii::app()->clientScript->registerCssFile($href, $media);
