...
/**
 * Este é a classe de modelo da tabela "pontos_estrategicos".
 *
 * Estas são as colunas disponíveis na tabela "pontos_estrategicos":
 * @property integer $id
 ...
 */
class PontoEstrategico extends ClienteActiveRecord
{
    /**
     * Armazena latitude
     * @var number
