...
class MunicipioTest extends TestCase
{
    ...
    public function testNotLoadCoordenadas() {   
        
        $municipio = Phactory::municipio(['nome' => 'Florianópolis']);
        
        $this->assertNull($municipio->coordenadas_area);
        
        $this->assertFalse($municipio->loadCoordenadas());
        
        $this->assertNull($municipio->latitude);
        
        $this->assertNull($municipio->longitude);
    }
