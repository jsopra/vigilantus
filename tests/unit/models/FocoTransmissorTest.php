...
class FocoTransmissorTest extends TestCase
{
    ...
    public function testScopeDoTipoDeposito()
    {
        ...
        $foco = Phactory::focoTransmissor([
            'tipo_deposito_id' => $tipoDepositoA->id,
        ]);
        ...
        $foco = Phactory::focoTransmissor([
            'tipo_deposito_id' => $tipoDepositoB->id,
        ]);
    ...
    public function testScopeDoBairro()
    {
        ...
        $foco = Phactory::focoTransmissor([
            'bairro_quarteirao_id' => Phactory::bairroQuarteirao(['bairro_id' => $bairroA->id]),
        ]);
        ...
        $foco = Phactory::focoTransmissor([
            'bairro_quarteirao_id' => Phactory::bairroQuarteirao(['bairro_id' => $bairroB->id]),
        ]);
    ...
    {
        $foco = Phactory::focoTransmissor([
            'imovel_id' => Phactory::imovel(['imovel_lira' => true]),
        ]);

        $foco = Phactory::focoTransmissor([
            'imovel_id' => Phactory::imovel(['imovel_lira' => false]),
        ]);
    ...
    public function testScopeDaEspecieTransmissor()
    {
        ...
        $foco = Phactory::focoTransmissor([
            'especie_transmissor_id' => $especieTransmissorA->id,
        ]);
        ...
        $foco = Phactory::focoTransmissor([
            'especie_transmissor_id' => $especieTransmissorB->id,
        ]);
