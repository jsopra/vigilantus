...
class AreaTratamentoReportTest extends TestCase
{
    ...
    public function testGetData() {
        ...
        $report->loadAreasDeTratamento($this->cliente);
    ...
    public function testGetDataComFiltro() {

        $idBairro = $this->_createScenario();
    ...
    private function _createScenario($quantidadeDeMetros = null, $quantidadeDiasValidadeFoco = null) {
        ...
        $this->cliente = $cliente = Phactory::cliente();
