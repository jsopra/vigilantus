...
$eu->quero('verificar que o CRUD Social Hashtags funciona');
$eu->facoLoginComo('administrador', 'administrador');
$eu->clico('Cadastro');
$eu->clico('XXX Item de menu do CRUD'); //@todo

$eu->espero('cadastrar um Social Hashtags');
...
$eu->espero('editar um Social Hashtags');
...
$eu->espero('excluir um Social Hashtags');
