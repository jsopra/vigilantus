...
$eu->quero('verificar que o CRUD Denuncia Tipo Problemas funciona');
$eu->facoLoginComo('administrador', 'administrador');
$eu->clico('Cadastro');
$eu->clico('XXX Item de menu do CRUD'); //@todo

$eu->espero('cadastrar um Denuncia Tipo Problemas');
...
$eu->espero('editar um Denuncia Tipo Problemas');
...
$eu->espero('excluir um Denuncia Tipo Problemas');
