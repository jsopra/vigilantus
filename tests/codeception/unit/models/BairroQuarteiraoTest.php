...
class BairroQuarteiraoTest extends ActiveRecordTest
{
    ...
    public function testNaoSalvaDuplicado()
    {
        ...
        $quarteiraoDuplicado->municipio_id = $outroBairro->municipio->id;
        $quarteiraoDuplicado->cliente_id = $outroBairro->cliente->id;
    ...
    public function testGetIDsAreaTratamento()
    {
        ...
        $bairro = Phactory::bairro(['cliente' => $cliente]);
        ...
        $imovel = Phactory::imovel([
            'cliente' => $cliente,
            'bairroQuarteirao' => $quarteiraoC,
        ]);

        $opcoesEspecie = ['cliente' => $cliente];
        $opcoesFoco = ['bairroQuarteirao' => $quarteiraoC, 'cliente' => $cliente];

        $especie = Phactory::especieTransmissor($opcoesEspecie);

        $opcoesFoco['especieTransmissor'] = $especie;
        Phactory::focoTransmissor($opcoesFoco);

        $ids = BairroQuarteirao::getIDsAreaTratamento($cliente->id);
    ...
    public function testScopeDoBairro()
    {
        ...
        $bairroA = Phactory::bairro(['cliente' => $cliente]);
        $bairroB = Phactory::bairro(['cliente' => $cliente]);
    ...
    public function testScopeComFocosAtivos()
    {
        ...
        $imovel = Phactory::imovel([
            'cliente' => $cliente,
            'bairroQuarteirao' => $quarteiraoB,
        ]);

        $especie = Phactory::especieTransmissor(['cliente' => $cliente]);

        $opcoesFoco['especieTransmissor'] = $especie;

        Phactory::focoTransmissor([
            'bairroQuarteirao' => $quarteiraoA,
            'cliente' => $cliente,
