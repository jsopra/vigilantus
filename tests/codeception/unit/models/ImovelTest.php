...
class ImovelTest extends ActiveRecordTest
{
    ...
    public function testScopeDaRua()
    {
        ...
        Phactory::imovel(['rua' => $ruaA]);
        Phactory::imovel(['rua' => $ruaA]);
        Phactory::imovel(['rua' => $ruaB]);
    ...
    public function testScopeDoQuarteirao()
    {
        ...
        Phactory::imovel(['bairroQuarteirao' => $quarteiraoA]);
        Phactory::imovel(['bairroQuarteirao' => $quarteiraoA]);
        Phactory::imovel(['bairroQuarteirao' => $quarteiraoB]);
