 ...
 */
namespace app\extensions\gii\generators\controller;

use Yii;
use yii\gii\CodeFile;
use yii\helpers\Html;
use yii\helpers\Inflector;
use yii\gii\generators\controller\Generator as YiiControllerGenerator;
 ...
 * @since 2.0
 */
class Generator extends YiiControllerGenerator
{
	/**
	...
	{
		return 'Gerador de Controller Vigilantus';
	}
	...
	{
		return 'Gera um controller com uma ou mais actions e suas views correspondentes.';
	}
