            ...
            foreach ($this->imoveis as $imovel)
            {
                ...
                if ($tratamentos) {
                    foreach ($imovel['tratamentos'] as $tratamento) {
                        ...
                        $visitaTratamento->focal_imovel_tratamento = $this->getValue($tratamento, 'focal_imovel_tratamento');
                        $visitaTratamento->focal_larvicida_tipo = $this->getValue($tratamento, 'focal_larvicida_tipo');
                        $visitaTratamento->focal_larvicida_qtde_gramas = $this->getValue($tratamento, 'focal_larvicida_qtde_gramas');
                        $visitaTratamento->focal_larvicida_qtde_dep_tratado = $this->getValue($tratamento, 'focal_larvicida_qtde_dep_tratado');
