...
<div class="bairro-index">
    ...
    echo GridView::widget([
        ...
        'buttons' => [
            'create' => function() {
                return Html::a(
                    'Cadastrar Ponto Estratégico',
                    Yii::$app->urlManager->createUrl('ponto-estrategico/create'),
                    [
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $index, $widget) {
                    return $model->bairro_quarteirao_id ? Html::encode($model->bairroQuarteirao->numero_quarteirao) : Html::encode(null);
                }
            ],
            [
                'attribute' => 'bairro_quarteirao_id',
                ...
                'filter' => false,
                'value' => function ($model, $index, $widget) {
                    return $model->bairro_quarteirao_id ? Html::encode($model->bairroQuarteirao->bairro->nome) : Html::encode(null);
                }
            ],
            [
