...
$descricaoPagina = 'Abri uma ocorrência para a Secretaria de Saúde de ' . $municipio->nome . ' - ' . $municipio->sigla_estado . '. Participe da mudança na nossa cidade! Acesse ' .  $urlOcorrencia;
