...
<div class="panel panel-default" style="margin-top: 2.5em;">
	...
	<div class="panel-heading ocorrencia">
		<h4  class="text-center" style="color: #CC0000; font-weight: bold; margin-top: 1em; font-size: 2.5em; margin-top: 0;">Registre uma ocorrência!</h4>
		<br />
		...
		Sua ocorrência será avaliada pela <font style="font-weight: bold; font-size: 1.05em; color: #000;">Prefeitura Municipal</font>
		e você receberá acesso para <font style="font-weight: bold; color: #000; font-size: 1.05em;">acompanhar</font> a resolução.
		</p>

		<p class="text-center" style="color: #000; font-size: 1.3em;"><strong>As informações da sua ocorrência são mantidas em sigilo</strong></p>
	</div>

	<div class="panel-body">

		<div class="cidade_formOcorrencia">
		    ...
		    <?php $form = ActiveForm::begin(['options' => ['enctype'=>'multipart/form-data']]); ?>
		        ...
		        <p><strong>Preenchendo seus dados, você recebe atualizações sobre a ocorrência em seu email. Todas as informações da são mantidas em sigilo. </strong></p>
